...
public class Group {
	...
	public Group(String iD, String name, String comments, String shareDataTemplateTypeID, String ownerID,
			String ownerName, String createdDate, String status, List<String> members) {
		super();
		ID = iD;
		this.name = name;
		this.comments = comments;
