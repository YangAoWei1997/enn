...
public class RelationInfo {
	...
	public RelationInfo(String id, String name, String version, String comments, String organizationId,
			...
			String friendName, String status, String issuedDate, String expiredDate, String reason) {
		super();
		this.id = id;
		this.name = name;
		this.version = version;
